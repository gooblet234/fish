...
class DesktopPet(QMainWindow):
    def __init__(self):
        ...
        self.movie = QMovie(resource_path("assets/pet.gif"))
    ...
    def cry_and_explode(self):
        ...
        self.physp = True
        self.dragging = False
        playsound(resource_path("assets/crying.mp3"))
        self.movie.stop()
        self.movie = QMovie(resource_path("assets/explosion.gif"))
        self.label.setMovie(self.movie)
        self.movie.start()
        playsound(resource_path("assets/explosion.mp3"))
        time.sleep(2)
        QApplication.quit()
    ...
    resource_path("assets/blub.mp3"),
    resource_path("assets/splat.mp3"),
    resource_path("assets/splash.mp3"),
    resource_path("assets/augh.mp3")
])
...
class PanicWindow(QMainWindow):
    ...
    def superkill_fish(self):
        playsound(resource_path("assets/gunshot.mp3"))
        time.sleep(1)
        playsound(resource_path("assets/gunshot.mp3"))
        time.sleep(0.25)
        playsound(resource_path("assets/sniper.mp3"))
        time.sleep(0.25)
        QApplication.quit()
